...
import { translatePaymentMethod, getPaymentMethodIcon } from '../utils/translations';
              ...
              <div className="info-item">
                ...
                <span className="info-value">
                  {reservation.paymentMethod ? (
                    <>
                      <i className={`fas ${getPaymentMethodIcon(reservation.paymentMethod)} me-2 text-success`}></i>
                      {translatePaymentMethod(reservation.paymentMethod)}
                    </>
                  ) : (
